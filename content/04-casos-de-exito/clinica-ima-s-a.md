---
title: "Clínica IMA S.A.: Odoo para Salud"
seo_title: "Clínica IMA S.A. | Casos de Odoo | Eynes"
meta_description: "Gestión de la información descentralizada, problemas de presentación de información ante ARCA"
slug: "clinica-ima-s-a"
estado: "publicado"
schema_type: "Article"
...
Gestión de la información descentralizada, problemas de presentación de información ante ARCA
...
EL DESAFÍO
"La gestión de la clínica se hacía con áreas totalmente desconectadas. El consumo de alimentos e insumos en cocina era imposible de controlar y auditar para el área de compras. Esto nos generaba demoras y sospechas de pérdidas constantes en los resultados de la clínica. Además, el equipo contable no daba abasto para cargar manualmente los archivos de los regímenes informativos mensuales que nos exigen las entidades de control."

LA SOLUCIÓN
"Centralizamos la gestión en un único entorno. Conectamos las áreas de compras, almacenes y gestión de proveedores para tener trazabilidad completa en los consumos en cocina. Además, implementamos la localización Argentina de Eynes para automatizar la generación de archivos para aplicativos."

EL RESULTADO
"Hubo una reducción importante de los tiempos de auditoría en el consumo de alimentos y generamos reportes con información confiable. Cuando se consumen alimentos en cocina, el sistema ya sabe a qué área se dedicará y a que centro de costos imputarlo. Además, las presentaciones ante ARCA ahora se generan con algunos clics, devolviéndole días de trabajo a nuestra administración."

## 06 — Módulos relevantes para el rubro

Facturación · Gestión de proveedores · Contabilidad. El circuito se completa con Compras e Inventario para el abastecimiento de cocina y de insumos, y con la localización argentina de Eynes para automatizar la generación de los archivos de los regímenes informativos.
...
### Consumo de cocina e insumos sin trazabilidad hacia compras

Una clínica con internación y quirófano tiene una operación de alimentos comparable a la de un restaurante, pero sin el circuito administrativo que la acompañe. Si el consumo de cocina no se registra contra el área y el centro de costos que lo origina, compras no puede auditarlo, y las diferencias entre lo comprado y lo consumido se leen como pérdidas sin explicación.

### Rechazos de facturación de obras sociales por errores manuales

Cada factura rechazada por una obra social o una prepaga es una cobranza que se posterga y un trabajo administrativo que se hace dos veces. Cuando el rechazo se origina en errores manuales de carga, el problema no es de gestión de cobranza sino de origen del dato.

### Regímenes de información armados a mano

Los regímenes de información que ARCA exige a prestadores de salud tienen volumen, formato y plazo. Armarlos a mano convierte cada cierre mensual en un cuello de botella que consume días del equipo contable y deja el cumplimiento dependiendo de que nadie se enferme ni se tome vacaciones.
