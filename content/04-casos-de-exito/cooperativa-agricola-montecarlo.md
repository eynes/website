...
Las básculas y balanzas industriales de la cooperativa no hablaban con el sistema de gestión. El pesaje de los camiones con materia prima —sobre todo yerba— se anotaba a mano en tickets de báscula y un administrativo los transcribía después, con errores de tipeo que generaban diferencias importantes en kilos. Validar esos tickets tomaba tiempo, y esa demora se trasladaba directo a la liquidación de pagos a los socios productores; tampoco había conexión entre el control de calidad en recepción (nivel de humedad) y la clasificación del inventario en los almacenes. La solución integró el hardware directamente con el software: básculas de camiones y sensores de calidad conectados en tiempo real con inventario y producción. Hoy el camión sube a la báscula, se presiona un botón y el peso neto entra al sistema sin margen de error, lo que permitió pasar a liquidaciones periódicas para los productores.
