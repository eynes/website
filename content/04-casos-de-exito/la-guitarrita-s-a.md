---
title: "La Guitarrita S.A.: Odoo para Gastronomía"
seo_title: "La Guitarrita S.A. | Casos de Odoo | Eynes"
meta_description: "Mermas de ingredientes no registradas, gestión de la administración ineficiente y auditorías de calidad poco fiables. Experiencia fallida con otro partner."
slug: "la-guitarrita-s-a"
estado: "publicado"
schema_type: "Article"
cliente: "La Guitarrita S.A."
rubro: "Gastronomía"
pais: ""
usuarios: ""
...
Mermas de ingredientes no registradas, gestión de la administración ineficiente y auditorías de calidad poco fiables. Experiencia fallida con otro partner.
...
EL DESAFÍO
Sabíamos que se nos iba plata en la cocina pero no podíamos medir dónde. Además veníamos de una implementación con otro partner que no había funcionado, así que arrancamos con desconfianza.

LA SOLUCIÓN
Con Eynes cargamos las recetas para que cada plato vendido descontara sus insumos, integramos los locales con la administración central y llevamos los controles de calidad al sistema.

EL RESULTADO
Hoy la merma se mide y se puede atacar. Y la diferencia con la experiencia anterior fue tener a alguien que entendía el negocio, no solo el software.
