---
title: "Comercializadora Casper S.A. (Casper Pet Store): Odoo para Pet Shop y Veterinaria"
seo_title: "Comercializadora Casper S.A. (Casper Pet Store) | Casos de Odoo | Eynes"
meta_description: "Dificultad para sincronizar en tiempo real el stock de su tienda online con el inventario físico de sus múltiples sucursales, generando riesgos de quiebres"
slug: "comercializadora-casper-s-a-casper-pet-store"
estado: "publicado"
schema_type: "Article"
cliente: "Comercializadora Casper S.A. (Casper Pet Store)"
...
Dificultad para sincronizar en tiempo real el stock de su tienda online con el inventario físico de sus múltiples sucursales, generando riesgos de quiebres. Falta de integración entre el agendamiento de servicios y el sistema de punto de venta (POS), sumado al desafío logístico de coordinar envíos de productos pesados y voluminosos.
...
EL DESAFÍO
Teníamos el stock de la web por un lado y el de los locales por otro. Vendíamos online cosas que ya no estaban, y los turnos de servicios a mascotas los anotábamos separados del sistema de gestión.

LA SOLUCIÓN
Con Eynes pasamos todo a Odoo: un único stock para las sucursales y la tienda, la agenda de servicios conectada al punto de venta, y las reglas de envío calculadas por peso y volumen.

EL RESULTADO
Hoy lo que se ve en la web es lo que hay para vender. Y el turno se cobra en el mismo lugar donde se agenda.
