---
title: "NP Electrónica Industrial: Odoo para Electrónica y Automatización"
seo_title: "NP Electrónica Industrial | Casos de Odoo | Eynes"
meta_description: "Trazabilidad de garantías ineficiente, control de micro-componentes obsoletos y seguimiento de reparaciones en papel."
slug: "np-electronica-industrial"
estado: "publicado"
schema_type: "Article"
cliente: "NP Electrónica Industrial"
...
Trazabilidad de garantías ineficiente, control de micro-componentes obsoletos y seguimiento de reparaciones en papel.
...
EL DESAFÍO
Las reparaciones se seguían en papel, pegado al equipo. Si un cliente llamaba para preguntar por su aparato, había que ir a buscarlo físicamente. Y con la garantía era peor: dependía de que alguien se acordara.

LA SOLUCIÓN
Con Eynes implementamos Odoo con órdenes de reparación y número de serie. Cada equipo tiene su historial: cuándo se vendió, a quién, qué se le hizo y qué repuestos llevó.

EL RESULTADO
Sabemos en el momento dónde está cada equipo y si está en garantía o no. Los repuestos que se consumen ahora llegan a la factura.
