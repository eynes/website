...
integraciones_destacadas: ["Mercado libre", "WMS (Gestión avanzada de Almacenes)", "Aleph", "ARCA", "Herramientas de Business Intelligence (BI)", "Catálogo de cruce de códigos"]
...
Mercado Libre, con publicación y sincronía de precios y stock en tiempo real: cuando Odoo recibe una venta del marketplace, dispara solo la facturación y el recibo de cobro correspondiente.

Gestión avanzada de almacenes (WMS) como fuente de verdad del stock físico en cada depósito y sucursal — el portal de clientes lee la disponibilidad real en estantería, así se terminan las ventas en falso.

Integración con Aleph.

ARCA para la facturación electrónica: emisión de facturas y recibos, validación de CAE y cálculo automático de percepciones y retenciones propias del rubro.

Herramientas de Business Intelligence para analizar rotación y rentabilidad del inventario por línea, marca o proveedor.

Catálogo de cruce de códigos: vincula un producto principal con sus códigos de barras, códigos de fabricante y equivalencias, para sugerir reemplazos compatibles cuando el pedido original no está en stock.
