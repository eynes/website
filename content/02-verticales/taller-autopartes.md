...
integraciones_destacadas: ["COT de ARBA desde el remito", "WMS por API REST y JSON-RPC", "Consultora logística coordinando ERP + WMS", "Impresión directa a impresoras de red"]
