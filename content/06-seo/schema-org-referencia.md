...
| Sectores (hub) | `CollectionPage` | `ItemList` (listando cada vertical) | |
...
- **BreadcrumbList en toda página que no sea el Home**, reflejando la jerarquía real: `Blog / [categoría] / [Título]`, `Sectores / [rubro]`, `Módulos / [módulo]`, etc.
